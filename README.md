...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/giaiteny/nid_wanren)  
...
* **务必替换所有的66d581b1-ddbb-4f53-aefe-4da241793766为部署时设置的AUUID**  
...
* 端口：443
* 默认UUID：66d581b1-ddbb-4f53-aefe-4da241793766
* 加密：none
* 传输协议：ws
* 伪装类型：none
* 路径：/66d581b1-ddbb-4f53-aefe-4da241793766-vless // 默认vless使用/$uuid-vless，vmess使用/$uuid-vmess
* 底层传输安全：tls
```
</details>
...
* 客户端下载: https://github.com/p4gefau1t/trojan-go/releases
{
    ...
    "remote_port": 443,
    "password": [
        "66d581b1-ddbb-4f53-aefe-4da241793766"
    ],
    "websocket": {
        "enabled": true,
        "path": "/66d581b1-ddbb-4f53-aefe-4da241793766-trojan",
...
* 插件选项: tls;host=appname.herokuapp.com;path=/66d581b1-ddbb-4f53-aefe-4da241793766-ss
```
</details>
